...
var url = 'https://www.sreality.cz/api/en/v2/estates?category_main_cb=1&category_type_cb=1&page=2&per_page=500&tms=1687730224465';
var Estate = /** @class */ (function () {
    function Estate(name, locality, url) {
        this.name = name;
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching JSON data:', error_1);
                    throw error_1;
